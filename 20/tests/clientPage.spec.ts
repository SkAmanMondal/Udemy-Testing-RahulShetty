...
// import * as dataSet from "../utils/orderValidationTestData.json";
// const dataSet = JSON.parse(JSON.stringify(import("../utils/orderValidationTestData")));
import { dataSet } from "../utils/orderValidationTestData";
...
for(const data of dataSet){
    test.only(`Order Validation for ${data.productName}`, async ({page})=>{
    ...
    await myordersPage.searchOrderAndView(orderIdTrimmed);
...
customTest("Order Validation", async ({page, testDataForOrder})=>{
